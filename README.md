...
#### B · Pip install from GitHub Releases

```bash
python -m pip install --upgrade pip
pip install \
  "foxtrot-core @ https://github.com/prjfoxtrot/foxtrot-core/releases/latest/download/foxtrot_core-latest-py3-none-any.whl" \
  "foxtrot-vivado-2024 @ https://github.com/prjfoxtrot/foxtrot-vivado-2024/releases/latest/download/foxtrot_vivado_2024-latest-py3-none-any.whl"
